...
class SaveMember(forms.ModelForm):
    ...
    mother = forms.CharField(max_length=250)
    father = forms.CharField(max_length=250)
    grandma = forms.CharField(max_length=250)
    thaivazhi = forms.CharField(max_length=250) 
    gender = forms.CharField(max_length=20)
    marital_status = forms.CharField(max_length=20)
    education = forms.CharField(max_length=250)
    ...
    class Meta:
        ...
        fields = ('code', 'group', 'first_name', 'middle_name', 'last_name','mother','father','grandma','thaivazhi', 'gender','marital_status','education', 'contact', 'email', 'address', 'status', 'image_path', )
